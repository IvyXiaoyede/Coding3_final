...
dataset：
## Description of work:
I used the DCGAN algorithm to process images from the Oxford Flowers 102 database and generate images with floral patterns. I trained the algorithm for several iterations, 500, 2000 and 4000 iterations respectively.
